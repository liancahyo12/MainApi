    ...
    private void initComponents() {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(etNama.getText()==null||etEmail.getText()==null||etPassword.getText()==null){
                    Toast.makeText(mContext, "Masukan Data Diri Terlebih Dahulu", Toast.LENGTH_SHORT).show();
                }else{
                    ...
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()){
                            ...
                            try {
                                ...
                                } else if(jsonRESULTS.getString("status").equals("emailerror")){
